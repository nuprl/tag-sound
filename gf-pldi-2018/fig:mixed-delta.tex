...
\lblextra{Language $\langM$}{ inherits Common Syntax:}{
$\begin{array}{l@{~~}c@{~~}l}
...
\lblmathparextra{$\Gamma \wellM e$}{ inherits $\Gamma \welldyn e$:}{
  \inferrule*{
    \Gamma \wellM e : \tau
  }{
...
\end{minipage}%
\begin{minipage}[t]{0.5\columnwidth}
\lblmathparextra{$\Gamma \wellM e : \tau$}{ inherits $\Gamma \wellsta e : \tau$:}{
  \inferrule*{
    \Gamma \wellM e
  }{
...
%% TODO use S/D instead of R/R', if keeping this
\smallskip
\lblextra{$\DSlift{E}{\rrR}{E'}{\rrRp}$}{ $= \vtuple{\ccR}{\ccRp}$ where:}{
$\begin{array}{l@{~~}c@{~~}l@{~~}l}
