\lblextra{Evaluation Syntax}{ extends Surface Syntax}{
  $\begin{array}{l@{\hspace{0.5em}}c@{\hspace{0.5em}}l}
    ...
    \\
    \esd & \BNFeq & \ebase\! \mid
      \eapp{\esd~}{e}\hspace{0.3em} \mid
      \eapp{v}{\esd}\hspace{0.2em} \mid
      \vpair{\esd}{e}\hspace{0.25em} \mid
      \vpair{v}{\esd}\hspace{0.4em} \mid
      \eunop{\esd}~ \mid
      \ebinop{\esd\,}{e}\hspace{0.25em} \mid
      \ebinop{v}{\esd}~ \mid \edyn{\tau}{\esd} \mid \esta{\tau}{\esd}
  \end{array}$
}
