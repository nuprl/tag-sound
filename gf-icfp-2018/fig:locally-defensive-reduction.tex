...
\begin{TwoColumn}
  \lblextra{$\vfromdynK : \specarr{\tpair{\tau}{v}}{v}\vphantom{\vfromstaK}$}{}{
    $\begin{array}{l@{~~}c@{~}l}
  ...
  \lblextra{$\vfromstaK : \specarr{\tpair{\tau}{v}}{v}$}{}{
    $\begin{array}{l@{~~}c@{~}l}
      \efromstaK{\tau}{v} & = & v
    \end{array}$
  }
...
\begin{flushleft}
  \fbox{$\vfromany : \specarr{\tpair{K}{v}}{v}$}\\[-2.7ex]{
