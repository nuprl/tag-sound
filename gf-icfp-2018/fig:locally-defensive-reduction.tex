...
\lblextra{$e \rrKEstar e$}{ reflexive, transitive closure of $\ccKS$, where $(\ccKS', \ccKD') = (\SDlift{\rrKS}{\rrKD})$ and}{
$\begin{array}{l@{\hspace{4.4em}}l}
  \fbox{$e \ccKS e$} \mbox{ extends $\ccKS'$} & \fbox{$e \ccKD e$} \mbox{ extends $\ccKD'$}
  \\
  {
    \begin{array}{l@{\hspace{0.5em}}c@{\hspace{0.5em}}l}
      \esd[\esta{\kany}{v}] & \ccS & \esd[v]
      \\
      \esd[\edyn{\kany}{v}] & \ccS & \esd[v]
    \end{array}
  } & {
    \begin{array}{l@{\hspace{0.5em}}c@{\hspace{0.5em}}l}
      \esd[\esta{\kany}{v}] & \ccS & \esd[v]
