\begin{TwoColumn}
  \lblextra{Language $\langK$}{ inherits Evaluation Syntax}{
    $\begin{array}{l@{\hspace{0.5em}}c@{\hspace{0.5em}}l}
      e & \BNFeq & \ldots \mid \edynfake{e} \mid
                   \estafake{e} \mid \echk{K}{e}
      \\
  ...
  %    \\
      ...
      \\
      \esd & \BNFeq & \ldots \mid \edynfake{\esd} \mid \estafake{\esd} \mid
              \echk{K}{\esd}
    \end{array}$
  }
...
\lbl{$\vfromany : K \times v \rightarrow v$}{
...
\begin{TwoColumn}
  ...
  \lblextra{$e \rrKS e$}{ inherits $\rrS$}{
    $\begin{array}{l@{\hspace{0.5em}}c@{\hspace{0.5em}}l}
      \echk{K}{v} & \rrKS
      & \mchk{K}{v}
      \\
  ...
  \lblextra{$e \rrKD e$}{ extends $\rrD$}{
    $\begin{array}{l@{\hspace{0.5em}}c@{\hspace{0.5em}}l}
      % blank space for chk & dyn-app rules
      \\
      \\
...
\begin{TwoColumn}
  \lblextra{$e \ccKE e$}{}{
    $\begin{array}{l@{\hspace{0.5em}}c@{\hspace{0.5em}}l}
      \esd[\estafake{v}] & \ccKE & \esd[v]
      \\
      \esd[\edynfake{v}] & \ccKE & \esd[v]
      \\
      ...
      \\
      \ebase[e] & \ccKE & \ebase[e']
      \\ \sidecond{if $e \rrVar{K} e'$}
      \\
      \esd[\eerr] & \ccKE & \eerr
    \end{array}$
  }
