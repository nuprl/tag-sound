...
\lblextra{$e \rrFD A$}{ (selected rules)}{
  $\begin{array}{l@{\hspace{0.5em}}c@{\hspace{0.5em}}l@{\hspace{1em}}l}
    ...
    & \rrFD & \esta{\tau_c}{(\echk{\tau_c}{\vsubst{e}{x}{v'}})}
    & \mbox{if $\mchk{\tau}{v} = v'$}
    \\
    \eapp{(\vmonfun{(\tarr{\tau_d}{\tau_c})}{(\vlam{\tann{x}{\tau}}{e})})}{v} & \rrFD
    & \boundaryerror
    & \mbox{if $\mchk{\tau}{v} = \boundaryerror$}
    \\
...
\lblextra{$e \rrFS A$}{ (selected rules)}{
  $\begin{array}{l@{\hspace{0.5em}}c@{\hspace{0.5em}}l@{\hspace{1em}}l}
    ...
    & \mbox{if $\mchk{\tau_d}{v} = v'$}
    \\
    \eapp{(\vmonfun{(\tarr{\tau_d}{\tau_c})}{(\vlam{x}{e})})}{v} & \rrFS
    & \boundaryerror
    & \mbox{if $\mchk{\tau_d}{v} = \boundaryerror$}
    \\
    \eapp{(\vmonfun{(\tarr{\tau_d}{\tau_c})}{(\vlam{\tann{x}{\tau}}{e})})}{v}
...
\lblextra{$e \rrFEstar A$}{ reflexive, transitive closure of $\ccFS$ (see Appendix)}{}
